  ...
  return (
    <RoleTemplate
      ...
      interactions={[
        ...
        "Alpha Werewolf - The Alpha Werewolf is woken up separately from the Werewolves. Investigate to see if you can find out who is the Alpha is so you don't kill him at night, because he plays with you as well, just not woken up at the same time.",
